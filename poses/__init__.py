...
# byte-faithful or the released OpenASL pose-only checkpoint sees OOD input and the pretraining is wasted. 
# (133-kp layout: body 0-16, feet 17-22, face 23-90, L hand 91-111,
# R hand 112-132.)
